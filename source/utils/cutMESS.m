...
%% online gas (gasflow, methane, co2)

% half-open interval [T_start, T_end): contiguous windows do not share boundary samples
...
MESS_cut.online_gas.rel_time_gasflow = days(MESS_cut.online_gas.time - T_start);  % [d]
...
MESS_cut.online_liq.rel_time   = days(MESS_cut.online_liq.time - T_start);  % [d]
...
MESS_cut.offline_ac_eq.rel_time    = days(MESS_cut.offline_ac_eq.time - T_start);  % [d]
...
MESS_cut.offline_nh3.rel_time   = days(MESS_cut.offline_nh3.time - T_start);  % [d]
...
MESS_cut.feed.rel_time        = days(MESS_cut.feed.time - T_start);  % [d]

%% window metadata

MESS_cut.T_start = T_start;
MESS_cut.T_end   = T_end;
MESS_cut.t_span  = days(T_end - T_start);  % [d]
