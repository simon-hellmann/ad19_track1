%% ADM1_R3_x1_core_ode.m
% ODE right-hand side for ADM1-R3-x1. Identical to ADM1-R3-Core except
% K_S_IN is promoted from c(8) to th(10); all gas-phase expressions use
% the same pre-computed c constants as ADM1-R3.
%
...
%   a:          (14x11) Petersen stoichiometry  (see setup_ADM1_R3_x1)
%

function [f, I_ac, I_ph, I_Nlim, I_nh3] = ADM1_R3_x1_core_ode(x, u, xi, th, c, a)
...
% dynamic equations (c indices unchanged from ADM1-R3-Core)
